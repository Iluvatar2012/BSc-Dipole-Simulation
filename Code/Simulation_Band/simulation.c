...
int init(struct parameters *param, double* init_positions) {
	...
	// check whether particle species ratio is correct
	if (X_A < 0 || X_A > 1) {
		fprintf(stderr, "Value X must be between 0 and 1 including, check configuration file and rerun. X: %lf\n", X_A);
		return EXIT_FAILURE;
	}
	...
	D_Brown_B 			= D_Brown_A;
	v_A					= gamma_shear/D_Brown_A*kT - gamma_shear/(D_rat*D_Brown_B)*kT;
...
static void *iteration_0 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*0]   + weigh_brown_A * g1 + position[2*0+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*1]   + weigh_brown_A * g1 + position[2*1+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*2]   + weigh_brown_A * g1 + position[2*2+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*3]   + weigh_brown_A * g1 + position[2*3+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*4]   + weigh_brown_A * g1 + position[2*4+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*5]   + weigh_brown_A * g1 + position[2*5+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*6]   + weigh_brown_A * g1 + position[2*6+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*7]   + weigh_brown_A * g1 + position[2*7+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*8]   + weigh_brown_A * g1 + position[2*8+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*9]   + weigh_brown_A * g1 + position[2*9+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*10]   + weigh_brown_A * g1 + position[2*10+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*11]   + weigh_brown_A * g1 + position[2*11+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*12]   + weigh_brown_A * g1 + position[2*12+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*13]   + weigh_brown_A * g1 + position[2*13+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*14]   + weigh_brown_A * g1 + position[2*14+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*15]   + weigh_brown_A * g1 + position[2*15+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*16]   + weigh_brown_A * g1 + position[2*16+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*17]   + weigh_brown_A * g1 + position[2*17+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*18]   + weigh_brown_A * g1 + position[2*18+1]*shear_A;
...
static void *iteration_1 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*19]   + weigh_brown_A * g1 + position[2*19+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*20]   + weigh_brown_A * g1 + position[2*20+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*21]   + weigh_brown_A * g1 + position[2*21+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*22]   + weigh_brown_A * g1 + position[2*22+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*23]   + weigh_brown_A * g1 + position[2*23+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*24]   + weigh_brown_A * g1 + position[2*24+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*25]   + weigh_brown_A * g1 + position[2*25+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*26]   + weigh_brown_A * g1 + position[2*26+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*27]   + weigh_brown_A * g1 + position[2*27+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*28]   + weigh_brown_A * g1 + position[2*28+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*29]   + weigh_brown_A * g1 + position[2*29+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*30]   + weigh_brown_A * g1 + position[2*30+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*31]   + weigh_brown_A * g1 + position[2*31+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*32]   + weigh_brown_A * g1 + position[2*32+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*33]   + weigh_brown_A * g1 + position[2*33+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*34]   + weigh_brown_A * g1 + position[2*34+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*35]   + weigh_brown_A * g1 + position[2*35+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*36]   + weigh_brown_A * g1 + position[2*36+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*37]   + weigh_brown_A * g1 + position[2*37+1]*shear_A;
...
static void *iteration_2 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*38]   + weigh_brown_A * g1 + position[2*38+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*39]   + weigh_brown_A * g1 + position[2*39+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*40]   + weigh_brown_A * g1 + position[2*40+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*41]   + weigh_brown_A * g1 + position[2*41+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*42]   + weigh_brown_A * g1 + position[2*42+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*43]   + weigh_brown_A * g1 + position[2*43+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*44]   + weigh_brown_A * g1 + position[2*44+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*45]   + weigh_brown_A * g1 + position[2*45+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*46]   + weigh_brown_A * g1 + position[2*46+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*47]   + weigh_brown_A * g1 + position[2*47+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*48]   + weigh_brown_A * g1 + position[2*48+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*49]   + weigh_brown_A * g1 + position[2*49+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*50]   + weigh_brown_A * g1 + position[2*50+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*51]   + weigh_brown_A * g1 + position[2*51+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*52]   + weigh_brown_A * g1 + position[2*52+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*53]   + weigh_brown_A * g1 + position[2*53+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*54]   + weigh_brown_A * g1 + position[2*54+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*55]   + weigh_brown_A * g1 + position[2*55+1]*shear_A;
...
static void *iteration_3 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*56]   + weigh_brown_A * g1 + position[2*56+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*57]   + weigh_brown_A * g1 + position[2*57+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*58]   + weigh_brown_A * g1 + position[2*58+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*59]   + weigh_brown_A * g1 + position[2*59+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*60]   + weigh_brown_A * g1 + position[2*60+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*61]   + weigh_brown_A * g1 + position[2*61+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*62]   + weigh_brown_A * g1 + position[2*62+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*63]   + weigh_brown_A * g1 + position[2*63+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*64]   + weigh_brown_A * g1 + position[2*64+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*65]   + weigh_brown_A * g1 + position[2*65+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*66]   + weigh_brown_A * g1 + position[2*66+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*67]   + weigh_brown_A * g1 + position[2*67+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*68]   + weigh_brown_A * g1 + position[2*68+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*69]   + weigh_brown_A * g1 + position[2*69+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*70]   + weigh_brown_A * g1 + position[2*70+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*71]   + weigh_brown_A * g1 + position[2*71+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*72]   + weigh_brown_A * g1 + position[2*72+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*73]   + weigh_brown_A * g1 + position[2*73+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*74]   + weigh_brown_A * g1 + position[2*74+1]*shear_A;
...
static void *iteration_4 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*75]   + weigh_brown_A * g1 + position[2*75+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*76]   + weigh_brown_A * g1 + position[2*76+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*77]   + weigh_brown_A * g1 + position[2*77+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*78]   + weigh_brown_A * g1 + position[2*78+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*79]   + weigh_brown_A * g1 + position[2*79+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*80]   + weigh_brown_A * g1 + position[2*80+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*81]   + weigh_brown_A * g1 + position[2*81+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*82]   + weigh_brown_A * g1 + position[2*82+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*83]   + weigh_brown_A * g1 + position[2*83+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*84]   + weigh_brown_A * g1 + position[2*84+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*85]   + weigh_brown_A * g1 + position[2*85+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*86]   + weigh_brown_A * g1 + position[2*86+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*87]   + weigh_brown_A * g1 + position[2*87+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*88]   + weigh_brown_A * g1 + position[2*88+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*89]   + weigh_brown_A * g1 + position[2*89+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*90]   + weigh_brown_A * g1 + position[2*90+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*91]   + weigh_brown_A * g1 + position[2*91+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*92]   + weigh_brown_A * g1 + position[2*92+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*93]   + weigh_brown_A * g1 + position[2*93+1]*shear_A;
...
static void *iteration_5 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*94]   + weigh_brown_A * g1 + position[2*94+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*95]   + weigh_brown_A * g1 + position[2*95+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*96]   + weigh_brown_A * g1 + position[2*96+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*97]   + weigh_brown_A * g1 + position[2*97+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*98]   + weigh_brown_A * g1 + position[2*98+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*99]   + weigh_brown_A * g1 + position[2*99+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*100]   + weigh_brown_A * g1 + position[2*100+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*101]   + weigh_brown_A * g1 + position[2*101+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*102]   + weigh_brown_A * g1 + position[2*102+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*103]   + weigh_brown_A * g1 + position[2*103+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*104]   + weigh_brown_A * g1 + position[2*104+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*105]   + weigh_brown_A * g1 + position[2*105+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*106]   + weigh_brown_A * g1 + position[2*106+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*107]   + weigh_brown_A * g1 + position[2*107+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*108]   + weigh_brown_A * g1 + position[2*108+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*109]   + weigh_brown_A * g1 + position[2*109+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*110]   + weigh_brown_A * g1 + position[2*110+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*111]   + weigh_brown_A * g1 + position[2*111+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*112]   + weigh_brown_A * g1 + position[2*112+1]*shear_A;
...
static void *iteration_6 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*113]   + weigh_brown_A * g1 + position[2*113+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*114]   + weigh_brown_A * g1 + position[2*114+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*115]   + weigh_brown_A * g1 + position[2*115+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*116]   + weigh_brown_A * g1 + position[2*116+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*117]   + weigh_brown_A * g1 + position[2*117+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*118]   + weigh_brown_A * g1 + position[2*118+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*119]   + weigh_brown_A * g1 + position[2*119+1]*shear_A;
			...
			dx = D_kT_A*delta_t*force[2*120]   + weigh_brown_A * g1 + position[2*120+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*120+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*121]   + weigh_brown_A * g1 + position[2*121+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*121+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*122]   + weigh_brown_A * g1 + position[2*122+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*122+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*123]   + weigh_brown_A * g1 + position[2*123+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*123+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*124]   + weigh_brown_A * g1 + position[2*124+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*124+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*125]   + weigh_brown_A * g1 + position[2*125+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*125+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*126]   + weigh_brown_A * g1 + position[2*126+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*126+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*127]   + weigh_brown_A * g1 + position[2*127+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*127+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*128]   + weigh_brown_A * g1 + position[2*128+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*128+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*129]   + weigh_brown_A * g1 + position[2*129+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*129+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*130]   + weigh_brown_A * g1 + position[2*130+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*130+1] + weigh_brown_A * g2;
...
static void *iteration_7 (int *no) {
		...
		while(cont == 1) {
			...
			dx = D_kT_A*delta_t*force[2*131]   + weigh_brown_A * g1 + position[2*131+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*131+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*132]   + weigh_brown_A * g1 + position[2*132+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*132+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*133]   + weigh_brown_A * g1 + position[2*133+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*133+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*134]   + weigh_brown_A * g1 + position[2*134+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*134+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*135]   + weigh_brown_A * g1 + position[2*135+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*135+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*136]   + weigh_brown_A * g1 + position[2*136+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*136+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*137]   + weigh_brown_A * g1 + position[2*137+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*137+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*138]   + weigh_brown_A * g1 + position[2*138+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*138+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*139]   + weigh_brown_A * g1 + position[2*139+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*139+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*140]   + weigh_brown_A * g1 + position[2*140+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*140+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*141]   + weigh_brown_A * g1 + position[2*141+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*141+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*142]   + weigh_brown_A * g1 + position[2*142+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*142+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*143]   + weigh_brown_A * g1 + position[2*143+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*143+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*144]   + weigh_brown_A * g1 + position[2*144+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*144+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*145]   + weigh_brown_A * g1 + position[2*145+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*145+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*146]   + weigh_brown_A * g1 + position[2*146+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*146+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*147]   + weigh_brown_A * g1 + position[2*147+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*147+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*148]   + weigh_brown_A * g1 + position[2*148+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*148+1] + weigh_brown_A * g2;
			...
			dx = D_kT_A*delta_t*force[2*149]   + weigh_brown_A * g1 + position[2*149+1]*shear_A;
			dy = D_kT_A*delta_t*force[2*149+1] + weigh_brown_A * g2;
...
static void *iteration_8 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_9 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_10 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_11 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_12 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_13 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_14 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
static void *iteration_15 (int *no) {
		// Define necessary variables
		double xi, xj, yi, yj;
		double dx, dy;
		double r_squared;
...
void simulation (void) {
	...
	ret_thread 	= pthread_create(&(threads[8]), NULL, (void*)&iteration_8, &(numbers[8]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 8);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[9]), NULL, (void*)&iteration_9, &(numbers[9]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 9);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[10]), NULL, (void*)&iteration_10, &(numbers[10]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 10);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[11]), NULL, (void*)&iteration_11, &(numbers[11]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 11);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[12]), NULL, (void*)&iteration_12, &(numbers[12]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 12);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[13]), NULL, (void*)&iteration_13, &(numbers[13]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 13);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[14]), NULL, (void*)&iteration_14, &(numbers[14]));

	if (ret_thread != 0) {
		fprintf(stderr, "Thread %d could not be created. \n", 14);
		exit(EXIT_FAILURE);
	}
	ret_thread 	= pthread_create(&(threads[15]), NULL, (void*)&iteration_15, &(numbers[15]));
