...
/*-------------------------------------------------------------------------------------------------------*/
int create_file (char* infile, struct attributes *attr) {
	...
	hid_t	attr_space_id_1, attr_space_id_2, attr_space_id_3, attr_space_id_4, attr_space_id_5, attr_space_id_6,\
			attr_space_id_7, attr_space_id_8, attr_space_id_9, attr_space_id_10, attr_space_id_11, attr_space_id_12,\
			attr_space_id_13;

	hid_t 	attr_id_1, attr_id_2, attr_id_3, attr_id_4, attr_id_5, attr_id_6, attr_id_7, attr_id_8, attr_id_9,\
			attr_id_10, attr_id_11, attr_id_12, attr_id_13;
	...
	attr_space_id_8  = H5Screate_simple(1, &attr_dim, NULL);
	attr_space_id_9  = H5Screate_simple(1, &attr_dim, NULL);
	attr_space_id_10 = H5Screate_simple(1, &attr_dim, NULL);
	attr_space_id_11 = H5Screate_simple(1, &attr_dim, NULL);
	attr_space_id_12 = H5Screate_simple(1, &attr_dim, NULL);
	attr_space_id_13 = H5Screate_simple(1, &attr_dim, NULL);
	...
	status = H5Aclose(attr_id_8);
	status = H5Aclose(attr_id_9);
	status = H5Aclose(attr_id_10);
	status = H5Aclose(attr_id_11);
	status = H5Aclose(attr_id_12);
	status = H5Aclose(attr_id_13);
	...
	status = H5Sclose(attr_space_id_8);
	status = H5Sclose(attr_space_id_9);
	status = H5Sclose(attr_space_id_10);
	status = H5Sclose(attr_space_id_11);
	status = H5Sclose(attr_space_id_12);
	status = H5Sclose(attr_space_id_13);
